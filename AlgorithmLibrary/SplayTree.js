...
SPLAYTREE.LINK_COLOR = "#2563eb";            // Primary color for links
SPLAYTREE.HIGHLIGHT_CIRCLE_COLOR = "#3b82f6"; // Primary light color
SPLAYTREE.FOREGROUND_COLOR = "#1e293b";      // Text primary color
SPLAYTREE.BACKGROUND_COLOR = "#f1f5f9";      // Light background
SPLAYTREE.PRINT_COLOR = "#1e293b";           // Text primary color
